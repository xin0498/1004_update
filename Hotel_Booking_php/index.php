                        ...
                        <div class="tab-content pl-md-5" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-room" role="tabpanel" aria-labelledby="v-pills-room-tab">
                                ...
                                <div class="justify-content-center">
                                    <a id="A1">
                                        <img src="img/bedroom1.jpg" id="shrinkImageThumbnail" />
                                        <span id="pop1" class="popup">
                                            <img src="img/bedroom1.jpg" id="shrinkImageBig"/>
                                        </span>
                                    </a>
                                    <a id="A2">
                                        <img src="img/bedroom2.jpg" id="shrinkImageThumbnail" />
                                        <span id="pop2" class="popup">
                                            <img src="img/bedroom2.jpg" id="shrinkImageBig"/>
                                        </span>
                                    </a>
                                    <a id="A3">
                                        <img src="img/bedroom3.jpg" id="shrinkImageThumbnail" />
                                        <span id="pop3" class="popup">
                                            <img src="img/bedroom3.jpg" id="shrinkImageBig"/>
                                        </span>
                                    </a>
                                    <a id="A4">
                                        <img src="img/bedroom4.jpg" id="shrinkImageThumbnail" />
                                        <span id="pop4" class="popup">
                                            <img src="img/bedroom4.jpg" id="shrinkImageBig"/>
                                        </span>
                                    </a>
                                </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-policy" role="tabpanel" aria-labelledby="v-pills-policy-tab">
                                ...
                                <span class="fa fa-star checked"></span>
                                <span class="fa fa-star checked"></span>
                                <p id="text2">By Chef Bob, Renowned Culinary Chef</p>
                                <hr>
                                ...
                                <p id="text2">By Lilian Wong, Trivago Hotel Manager</p>
                            </div>
                        </div>
                    </div>
                </div>
